...
func NewGokitProject(rootDir string) (cmdnew.ProjectFactory, error) {
...
func (factory gokitFactory) getProjectDirs() []string {
	return []string{
		...
		g.GetDir(factory.rootDir, g.Grpc),
		g.GetDir(factory.rootDir, g.Http),
...
func (factory gokitFactory) createScriptFile() error {
...
func (factory gokitFactory) copy3rdProtoFiles() error {
...
// create go.mod file
func (factory gokitFactory) createGoModuleFile() error {
